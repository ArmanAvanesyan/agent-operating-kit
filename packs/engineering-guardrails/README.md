...
- `cursor`, `opencode`, `gemini`, `openclaw`, `hermes-agent`: generated import bundle metadata and JSON contracts via `aok render pack engineering-guardrails --target <target>`.
